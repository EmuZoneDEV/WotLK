...
-- Exportiere Struktur von Tabelle wotlk_chars.item_soulbound_trade_data
...
-- Exportiere Daten aus Tabelle wotlk_chars.item_soulbound_trade_data: ~0 rows (ungefähr)
