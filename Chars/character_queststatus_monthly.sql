...
-- Exportiere Struktur von Tabelle wotlk_chars.character_queststatus_monthly
...
-- Exportiere Daten aus Tabelle wotlk_chars.character_queststatus_monthly: ~0 rows (ungefähr)
