...
-- Exportiere Struktur von Tabelle wotlk_chars.character_queststatus_seasonal
...
-- Exportiere Daten aus Tabelle wotlk_chars.character_queststatus_seasonal: ~0 rows (ungefähr)
