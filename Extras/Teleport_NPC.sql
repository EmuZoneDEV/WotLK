...
(15, @GOSSIP_MENU+1, 1, 6, 469, "Die Todesminen"),
(15, @GOSSIP_MENU+1, 2, 6, 469, "Das Verlies"),
(15, @GOSSIP_MENU+1, 3, 6, 67, "Der Flammenschlund"),
(15, @GOSSIP_MENU+1, 4, 6, 67, "Hügel der Klingenhauer"),
(15, @GOSSIP_MENU+1, 5, 6, 67, "Der Kral von Razorfen"),
(15, @GOSSIP_MENU+1, 6, 6, 67, "Das Schalachrote Kloster"),
(15, @GOSSIP_MENU+1, 7, 6, 67, "Burg Schattenfang"),
(15, @GOSSIP_MENU+1, 8, 6, 67, "Die Höhlen des Wehklagens"),
...
(@GOSSIP_MENU, 1, 2, "Sturmwind", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU, 2, 2, "Orgrimmar", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU, 3, 2, "Darnassus", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU, 4, 2, "Eisenschmiede", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU, 5, 2, "Exodar", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU, 6, 2, "Donnerfels", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU, 7, 2, "Unterstadt", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU, 8, 2, "Silbermond", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU, 9, 2, "Dalaran", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU, 10, 2, "Shattrath", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU, 11, 2, "Beutebucht", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU, 12, 2, "Arena der Gurubashi", 1, 1, @GOSSIP_MENU, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
...
(@GOSSIP_MENU, 17, 9, "Klassische Instanzen", 1, 1, @GOSSIP_MENU+1, 0, 0, 0, NULL),
(@GOSSIP_MENU, 18, 9, "BC Instanzen", 1, 1, @GOSSIP_MENU+2, 0, 0, 0, NULL),
(@GOSSIP_MENU, 19, 9, "WotLK Instanzen", 1, 1, @GOSSIP_MENU+3, 0, 0, 0, NULL),
(@GOSSIP_MENU, 20, 9, "Schlachtzug Punkte", 1, 1, @GOSSIP_MENU+4, 0, 0, 0, NULL),
(@GOSSIP_MENU+1, 0, 2, "Gnomeregan", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 1, 2, "Die Todesminen", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 2, 2, "Das Verlies", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 3, 2, "Der Flammenschlund", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 4, 2, "Hügel der Klingenhauer", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 5, 2, "Der Kral von Razorfen", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 6, 2, "Das Schalachrote Kloster", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 7, 2, "Burg Schattenfang", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 8, 2, "Die Höhlen des Wehklagens", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 9, 2, "Die Schwarzfelstiefen", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 10, 2, "Der Schwarzfels", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 11, 2, "Die Schwarzfelsspitze", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 12, 2, "Düsterbruch", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 13, 2, "Maraudon", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 14, 2, "Scholomance", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 15, 2, "Stratholme", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 16, 2, "Der versunkene Tempel", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 17, 2, "Uldaman", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 18, 2, "Zul'Farrak", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+1, 19, 7, "Zurück..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+2, 0, 2, "Auchindoun", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+2, 1, 2, "Die Höhlen der Zeit", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+2, 2, 2, "Die Sklavenunterkünfte", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+2, 3, 2, "Die Höllenfeuerzitadelle", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+2, 4, 2, "Terrasse der Magister", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+2, 5, 2, "Festung der Stürme", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+2, 6, 7, "Zurück..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+3, 0, 2, "Azjol-Nerub", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+3, 1, 2, "Das Ausmerzen von Stratholme", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+3, 2, 2, "Prüfung des Champions", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+3, 3, 2, "Drak'Tharon Keep", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+3, 4, 2, "Gundrak", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+3, 5, 2, "Eiskronen Zitadelle Instanzen", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+3, 6, 2, "Nexus Instanzen", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+3, 7, 2, "The Violet Hold", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+3, 8, 2, "Hallen des Lichts", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+3, 9, 2, "Hallen der Steine", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+3, 10, 2, "Burg Utgarde", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+3, 11, 2, "Utgarde Pinnacle", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+3, 12, 7, "Zurück..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+4, 0, 2, "Der schwarze Tempel", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 1, 2, "Der Pechschwingenhort", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 2, 2, "Der Berg Hyjal", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 3, 2, "Serpentshrine Cavern", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 4, 2, "Prüfung des Kreuzfahrers", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 5, 2, "Gruul's Hort", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 6, 2, "Magtheridon's Hort", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 7, 2, "Eiskronenzitadelle", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 8, 2, "Karazhan", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 9, 2, "Der geschmolzene Kern", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 10, 2, "Naxxramas", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 11, 2, "Onyxia's Hort", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 12, 2, "Ruins von Ahn'Qiraj", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 13, 2, "Sunwell Plateau", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 14, 2, "The Eye", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 15, 2, "Temple von Ahn'Qiraj", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 16, 2, "The Eye of Eternity", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 17, 2, "Das Obsidian Sanktum", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 18, 2, "Ulduar", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 19, 2, "Vault of Archavon", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 21, 2, "Zul'Gurub", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 22, 2, "Zul'Aman", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+4, 23, 7, "Zurück..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+5, 0, 2, "Elwynn Forest", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 1, 2, "Eversong Woods", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 2, 2, "Dun Morogh", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 3, 2, "Tirisfal Glades", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 4, 2, "Ghostlands", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 5, 2, "Loch modan", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 6, 2, "Silverpine Forest", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 7, 2, "Westfall", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 8, 2, "Redridge mountains", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 9, 2, "Duskwood", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 10, 2, "Hillsbrad Foothills", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 11, 2, "Wetlands", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 12, 2, "Alterac Mountains", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 13, 2, "Arathi Highlands", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 14, 2, "Stranglethorn Vale", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 15, 2, "Badlands", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 16, 2, "Sümpfe des Elends", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 17, 2, "Das Hinterland", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 18, 2, "Die sengende Schlucht", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 19, 2, "Die verwüsteten Lande", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 20, 2, "Die brennende Steppe", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 21, 2, "Westliche Pestländer", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 22, 2, "Östliche Pestländer", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 23, 2, "Insel von Quel'Danas", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+5, 24, 7, "Zurück..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+6, 0, 2, "Azuremyst Isle", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 1, 2, "Teldrassil", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 2, 2, "Durotar", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 3, 2, "Mulgore", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 4, 2, "Blutmythosinsel", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 5, 2, "Dunkelküste", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 6, 2, "Das Brachland", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 7, 2, "Steinkrallengebirge", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 8, 2, "Eschenwald", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 9, 2, "Tausend Nadeln", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 10, 2, "Desolace", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 11, 2, "Dustwallow Marschen", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 12, 2, "Feralas", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 13, 2, "Wüste von Tanaris", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 14, 2, "Azshara", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 15, 2, "Teufelswald", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 16, 2, "Krater von Un'Goro", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 17, 2, "Silithus", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 18, 2, "Winterspring", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+6, 19, 7, "Zurück..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+7, 0, 2, "Höllenfeuerhalbinsel", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+7, 1, 2, "Zangarmarschen", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+7, 2, 2, "Wald von Terokkar", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+7, 3, 2, "Nagrand", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+7, 4, 2, "Blade's Edge Mountains", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+7, 5, 2, "Nethersturm", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+7, 6, 2, "Schattenmondtal", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+7, 7, 7, "Zurück..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL),
(@GOSSIP_MENU+8, 0, 2, "Boreanische Tundra", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+8, 1, 2, "Heulender Fjord", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+8, 2, 2, "Drachenöde", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+8, 3, 2, "Grizzly Hügel", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+8, 4, 2, "Zul'Drak", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+8, 5, 2, "Sholazar Basin", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+8, 6, 2, "Kristallsangwald", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+8, 7, 2, "Storm Peaks", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+8, 8, 2, "Eiskrone", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+8, 9, 2, "Wintergrasp", 1, 1, 0, 0, 0, 0, "Bist du sicher, du willst wirklich dorthin reisen?"),
(@GOSSIP_MENU+8, 10, 7, "Zurück..", 1, 1, @GOSSIP_MENU, 0, 0, 0, NULL);
